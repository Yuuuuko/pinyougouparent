		...
		<div id="item">
			<div class="crumb-wrap">
				<ul class="sui-breadcrumb">
					<li>
						<a href="#">${category1Id.name}</a>
					</li>
					<li>
						<a href="#">${category2Id.name}</a>
					</li>
					<li>
						<a href="#">${category3Id.name}</a>
					</li>
				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<#if (imgList?size > 0)>
							<span class="jqzoom"><img jqimg="${imgList[0].url}" src="${imgList[0].url}" height="400px" width="400px"/></span>
							</#if>
						</div>
						<!--下方的缩略图-->
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd><a href="javascript:;" ng-class="{selected:specificationItems['${item.attributeName}']=='${value}'}" ng-click="selectSpecification('${item.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
						...
						<div class="summary-wrap">
							<div class="fl title">
								<div class="control-group">
									<div class="controls">
                                        <input autocomplete="off" type="text" value="1" ng-model="goodsCount"  minnum="1" class="itxt" />
                                        <a href="javascript:void(0)" class="increment plus" ng-click="addCount(1)">+</a>
                                        <a href="javascript:void(0)" class="increment mins" ng-click="addCount(-1)">-</a>
									</div>
								</div>
							</div>
							<div class="fl">
